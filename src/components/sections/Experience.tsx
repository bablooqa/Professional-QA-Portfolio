  ...
  const experiences = [
    {
      ...
      description:
        "Led quality assurance for POS System development, transitioning from manual to automated testing while maintaining high standards through CI/CD integration.",
    ...
    },
    {
      ...
      description:
        "Developed and executed QA processes for KYC/ReKYC projects, ensuring compliance with regulatory standards while automating key testing tasks.",
            ...
            <div
              ...
              className={cn(
                ...
                index !== experiences.length - 1 &&
                  "before:absolute before:left-[50%] before:-translate-x-[50%] before:top-full before:h-4 before:w-0.5 before:bg-gradient-to-b before:from-primary/50 before:to-transparent before:md:hidden"
              )}
            >
              ...
              <GradientCard className="transform transition-all duration-300 hover:scale-[1.02]">
                <div className="flex flex-col md:flex-row justify-between items-start mb-4">
                  ...
                  <Badge className="mt-2 md:mt-0 bg-gradient-to-r from-cyan-400 to-blue-600 text-white border-0">
                    {exp.period}
                  </Badge>
                </div>
                  ...
                  <div className="flex flex-wrap gap-2">
                    {exp.skills.map((skill) => (
                      <Badge
                        key={skill}
                        variant="secondary"
                        className="bg-cyan-500/10 text-cyan-500 hover:bg-cyan-500/20 transition-colors border-cyan-500/20"
                      >
                        {skill}
                      </Badge>
                    ))}
